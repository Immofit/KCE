    ...
    public partial class MainForm : Form
    {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                AddRow("1.Груз 1", "Путь", $"{res.S1:F3} мм");
                AddRow("2.Груз 1", "Скорость", $"{res.V1 / 1000.0:F3} м/с");
                AddRow("3.Груз 1", "Ускорение", $"{res.A1 / 1000.0:F3} м/с²");
                AddRow("4.Блок 2", "Угловая скорость", $"{res.Omega2:F3} рад/с");
                AddRow("5.Блок 2", "Угловое ускорение", $"{res.Epsilon2:F3} рад/с²");
                AddRow("6.Точка A", "Скорость", $"{res.Va / 1000.0:F3} м/с");
                AddRow("7.Точка A", "Танг. ускорение", $"{res.Ata / 1000.0:F3} м/с²");
                AddRow("8.Точка B", "Скорость", $"{res.Vb / 1000.0:F3} м/с");
                AddRow("9.Точка B", "Танг. ускорение", $"{res.Atb / 1000.0:F3} м/с²");
                AddRow("10.Блок 3", "Угловая скорость", $"{res.Omega3:F3} рад/с");
                AddRow("11.Блок 3", "Угловое ускорение", $"{res.Epsilon3:F3} рад/с²");
                AddRow("12.Точка M", "Скорость", $"{res.Vm:F3} м/с");
                AddRow("13.Точка M", "Норм. ускорение", $"{res.AnM:F3} м/с²");
                AddRow("14.Точка M", "Танг. ускорение", $"{res.AtM:F3} м/с²");
                AddRow("15.Точка M", "Полное ускорение", $"{res.ATotalM:F3} м/с²");
